        ...
        <div className="border-t border-sage-700 mt-12 pt-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-x-3 gap-y-1 text-xs text-sage-400">
              ...
              <Link href="/terapia-online/málaga" className="hover:text-white transition-colors">Málaga</Link>
              <Link href="/terapia-online/murcia" className="hover:text-white transition-colors">Murcia</Link>
              <Link href="/terapia-online/palma" className="hover:text-white transition-colors">Palma</Link>
              ...
              <Link href="/terapia-online/córdoba" className="hover:text-white transition-colors">Córdoba</Link>
              ...
              <Link href="/terapia-online/gijón" className="hover:text-white transition-colors">Gijón</Link>
              <Link href="/terapia-online/lhospitalet-de-llobregat" className="hover:text-white transition-colors">L&apos;Hospitalet</Link>
              <Link href="/terapia-online/a-coruña" className="hover:text-white transition-colors">A Coruña</Link>
              ...
              <Link href="/terapia-online/móstoles" className="hover:text-white transition-colors">Móstoles</Link>
              <Link href="/terapia-online/alcalá-de-henares" className="hover:text-white transition-colors">Alcalá</Link>
              ...
              <Link href="/terapia-online/almería" className="hover:text-white transition-colors">Almería</Link>
              <Link href="/terapia-online/leganés" className="hover:text-white transition-colors">Leganés</Link>
              <Link href="/terapia-online/san-sebastián" className="hover:text-white transition-colors">San Sebastián</Link>
              ...
              <Link href="/terapia-online/castellón-de-la-plana" className="hover:text-white transition-colors">Castellón</Link>
              ...
              <Link href="/terapia-online/alcorcón" className="hover:text-white transition-colors">Alcorcón</Link>
              <Link href="/terapia-online/san-cristóbal-de-la-laguna" className="hover:text-white transition-colors">La Laguna</Link>
              <Link href="/terapia-online/logroño" className="hover:text-white transition-colors">Logroño</Link>
              ...
              <Link href="/terapia-online/león" className="hover:text-white transition-colors">León</Link>
              <Link href="/terapia-online/cádiz" className="hover:text-white transition-colors">Cádiz</Link>
          ...
          <div className="mb-8">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap justify-center gap-x-3 gap-y-1 text-xs text-sage-400">
                ...
                <Link href="/duelo/online/málaga" className="hover:text-white transition-colors">Málaga</Link>
                <Link href="/duelo/online/murcia" className="hover:text-white transition-colors">Murcia</Link>
                <Link href="/duelo/online/palma" className="hover:text-white transition-colors">Palma</Link>
                ...
                <Link href="/duelo/online/córdoba" className="hover:text-white transition-colors">Córdoba</Link>
                ...
                <Link href="/duelo/online/gijón" className="hover:text-white transition-colors">Gijón</Link>
                <Link href="/duelo/online/lhospitalet-de-llobregat" className="hover:text-white transition-colors">L&apos;Hospitalet</Link>
                <Link href="/duelo/online/a-coruña" className="hover:text-white transition-colors">A Coruña</Link>
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap justify-center gap-x-3 gap-y-1 text-xs text-sage-400">
                ...
                <Link href="/pareja/online/málaga" className="hover:text-white transition-colors">Málaga</Link>
                <Link href="/pareja/online/murcia" className="hover:text-white transition-colors">Murcia</Link>
                <Link href="/pareja/online/palma" className="hover:text-white transition-colors">Palma</Link>
                ...
                <Link href="/pareja/online/córdoba" className="hover:text-white transition-colors">Córdoba</Link>
                ...
                <Link href="/pareja/online/gijón" className="hover:text-white transition-colors">Gijón</Link>
                <Link href="/pareja/online/lhospitalet-de-llobregat" className="hover:text-white transition-colors">L&apos;Hospitalet</Link>
                <Link href="/pareja/online/a-coruña" className="hover:text-white transition-colors">A Coruña</Link>
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap justify-center gap-x-3 gap-y-1 text-xs text-sage-400">
                ...
                <Link href="/ansiedad/online/málaga" className="hover:text-white transition-colors">Málaga</Link>
                <Link href="/ansiedad/online/murcia" className="hover:text-white transition-colors">Murcia</Link>
                <Link href="/ansiedad/online/palma" className="hover:text-white transition-colors">Palma</Link>
                ...
                <Link href="/ansiedad/online/córdoba" className="hover:text-white transition-colors">Córdoba</Link>
                ...
                <Link href="/ansiedad/online/gijón" className="hover:text-white transition-colors">Gijón</Link>
                <Link href="/ansiedad/online/lhospitalet-de-llobregat" className="hover:text-white transition-colors">L&apos;Hospitalet</Link>
                <Link href="/ansiedad/online/a-coruña" className="hover:text-white transition-colors">A Coruña</Link>
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap justify-center gap-x-3 gap-y-1 text-xs text-sage-400">
                ...
                <Link href="/depresion/online/málaga" className="hover:text-white transition-colors">Málaga</Link>
                <Link href="/depresion/online/murcia" className="hover:text-white transition-colors">Murcia</Link>
                <Link href="/depresion/online/palma" className="hover:text-white transition-colors">Palma</Link>
                ...
                <Link href="/depresion/online/córdoba" className="hover:text-white transition-colors">Córdoba</Link>
                ...
                <Link href="/depresion/online/gijón" className="hover:text-white transition-colors">Gijón</Link>
                <Link href="/depresion/online/lhospitalet-de-llobregat" className="hover:text-white transition-colors">L&apos;Hospitalet</Link>
                <Link href="/depresion/online/a-coruña" className="hover:text-white transition-colors">A Coruña</Link>
          ...
          <div>
            ...
            <div className="flex flex-wrap justify-center gap-x-3 gap-y-1 text-xs text-sage-400">
              ...
              <Link href="/presencial/piélagos" className="hover:text-white transition-colors">Piélagos</Link>
